...
from bot import ZYRO as bot
from bot import user_collection, collection, user_nguess_progress, user_guess_progress, SUPPORT_CHAT_ID as chat
...
async def mclaim(_, message: t.Message):
    ...
    try:
        ...
        if str(message.chat.id) != chat:
            join_button = InlineKeyboardMarkup([[InlineKeyboardButton("Join Here", url="https://t.me/+eg1W0oek5CMwYzg1")]])
        ...
        for character in unique_characters:
            await message.reply_photo(
                ...
                caption=(
                    ...
                    f"💫 ℭ𝔬𝔪𝔢 𝔟𝔞𝔠𝔨 𝔱𝔬𝔪𝔢 𝔣𝔬𝔯 𝔞𝔫𝔬𝔱𝔥𝔢𝔯 𝔠𝔩𝔞𝔦𝔪!"
                )
            )
